...
../src/bufferutil.cc:93:51: error: no matching function for call to ‘v8::Value::Int32Value()’
   93 |     unsigned int dataOffset = info[3]->Int32Value();
      |                                                   ^
In file included from ../src/bufferutil.cc:8:
/root/.cache/node-gyp/12.16.1/include/node/v8.h:2709:40: note: candidate: ‘v8::Maybe<int> v8::Value::Int32Value(v8::Local<v8::Context>) const’
...
gyp ERR! cwd /root/Documents/ethereum/LatestEthereum/node_modules/@web3-js/websocket
